...
export function ProPaywallContent({ showActivateCta = true }: ProPaywallContentProps) {
  ...
  return (
    ...
    >
      ...
      <View style={[styles.planSelector, { backgroundColor: colors.card, borderColor: colors.border }]}>
        ...
        >
          <Text
            style={[
              styles.planAmount,
              { color: selectedPlan === "monthly" ? colors.foreground : colors.mutedForeground },
            ]}
          >
            $29
          </Text>
        ...
        >
          <View style={styles.planTopRow}>
            <Text
              style={[
                styles.planAmount,
                { color: selectedPlan === "yearly" ? colors.foreground : colors.mutedForeground },
              ]}
            >
              $199
            </Text>
      ...
      {DIFFERENTIALS.map((d) => (
        <View key={d.title} style={[styles.diffRow, { borderBottomColor: colors.border }]}>
      ...
      <View style={[styles.communityCard, { backgroundColor: "#080808", borderColor: colors.border }]}>
        ...
        <Text style={[styles.communityDesc, { color: colors.secondaryForeground }]}>
          Traders que operan con contexto real. No teoría — setups activos, análisis en vivo y cuando el
          mercado se mueve, alguien ya lo vio venir.
        </Text>
        <TouchableOpacity
